 ...
 * @var string[]|\Cake\Collection\CollectionInterface $gêneros
 * @var string[]|\Cake\Collection\CollectionInterface $especiais
 * @var string[]|\Cake\Collection\CollectionInterface $escolaridades
...
<section>
  <div class="container">
    ...
    <div class="botao">
      ...
      <?= $this->Form->button(__('Salvar'), ['class' => 'btn btnvagas', 'style' => 'width: 216px;']) ?>
      <?= $this->Form->end() ?>
    </div>
</section>
